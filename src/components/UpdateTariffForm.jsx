...
function UpdateTariffForm({tariffId}) {
    ...
    const getTariffDetails = React.useCallback(() => {
        axios({
            method:'GET',
            url:`${process.env.REACT_APP_API}/tariff/details/${tariffId}`,
        }).then((res) => {
            if(res.data){
                let d = res.data;
                setValues((prevState) => ({
                    ...
                    driver_allowance:d.driver_allowance,
                    gst:d.gst
                }))
            }
        }).catch((err) => {
    ...
    const signup = (event) => {
        ...
        axios.put(`${process.env.REACT_APP_API}/admin/tariff/update/${tariffId}/${isAuthenticated()?.admin?._id}`,{
            ...data
        },{
            headers:{
  ...
  return <div className='App'>
      <div className='form-container'>
          ...
          <form className='form' onSubmit={signup}>
              <h2 style={{textAlign:'left', marginLeft:'5%', fontWeight:'350', letterSpacing:'5px'}}>UPDATE TARIFF</h2>
